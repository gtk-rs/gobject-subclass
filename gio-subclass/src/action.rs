// This file was generated by gir (https://github.com/gtk-rs/gir @ 5b90945+)
...
pub trait ActionImpl: AnyImpl + 'static {
    ...
    fn change_state(&self, action: &T, value: &glib::Variant);

    fn get_enabled(&self, action: &T) -> bool;

    fn get_name(&self, action: &T) -> Option<String>;

    fn get_parameter_type(&self, action: &T) -> Option<glib::VariantType>;

    fn get_state(&self, action: &T) -> Option<glib::Variant>;

    fn get_state_hint(&self, action: &T) -> Option<glib::Variant>;

    fn get_state_type(&self, action: &T) -> Option<glib::VariantType>;
...
unsafe extern "C" fn action_get_type<T: ObjectType>(
    ...
    let interface_static = klass.get_interface_static(ffi::action_get_type()) as *const ActionStatic<T>;
