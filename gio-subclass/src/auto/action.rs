    ...
    match imp.get_name(&wrap)
    {
        Some(t) => {
            ...
            gobject_ffi::g_object_set_qdata_full(gptr as *mut gobject_ffi::GObject,
                glib_ffi::g_quark_from_string("rs_action_get_name".to_glib_none().0),
                ret as *mut c_void,
                Some(destroy_ret)
            );
            ret
...
(gptr: *mut gio_ffi::GAction) -> *const glib_ffi::GVariantType
{
    ...
    match imp.get_parameter_type(&wrap)
    {
        Some(t) => {
            ...
            gobject_ffi::g_object_set_qdata_full(gptr as *mut gobject_ffi::GObject,
                glib_ffi::g_quark_from_string("rs_action_get_parameter_type".to_glib_none().0),
                ret as *mut c_void,
                Some(destroy_ret)
            );
            ret
...
(gptr: *mut gio_ffi::GAction) -> *const glib_ffi::GVariantType
{
    ...
    match imp.get_state_type(&wrap)
    {
        Some(t) => {
            ...
            gobject_ffi::g_object_set_qdata_full(gptr as *mut gobject_ffi::GObject,
                glib_ffi::g_quark_from_string("rs_action_get_state_type".to_glib_none().0),
                ret as *mut c_void,
                Some(destroy_ret)
            );
            ret
